 ...
 * Generated at: 2019-01-16 21:26:02 UTC
...
public final class trueEnding_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<audio id=\"footprint\" autoplay src=\"");
      out.print(request.getContextPath());
      out.write("/audio/footprint.wav\"></audio>\r\n");
      out.write("<audio id=\"gun\" src=\"");
      out.print(request.getContextPath());
      out.write("/audio/gun.mp3\"></audio>\r\n");
      out.write("<audio id=\"people\" src=\"");
      out.print(request.getContextPath());
      out.write("/audio/people.wav\"></audio>\r\n");
      out.write("<audio id=\"policesiren\" src=\"");
      out.print(request.getContextPath());
      out.write("/audio/policesiren.wav\"></audio>\r\n");
      out.write("<audio id=\"reload\" src=\"");
      out.print(request.getContextPath());
      out.write("/audio/reload.wav\"></audio>\r\n");
      out.write("<audio id=\"trueEnd\" src=\"");
      out.print(request.getContextPath());
      out.write("/audio/trueEnd.mp3\"></audio>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t$(\"#msgBox\").addClass(\"none\");\r\n");
      out.write("\t}\r\n");
      out.write("\tif(cnt==6) {\r\n");
      out.write("\t\t$(\"#msgBox\").removeClass(\"none\");\r\n");
      out.write("\t\t$(\"#msgBox\").addClass(\"you\");\r\n");
      out.write("\t\t$(\"#trueEnd\")[0].play();\r\n");
      out.write("\t}\r\n");
      out.write("\tif(cnt==9) {\r\n");
      out.write("\t\t$(\"#msgBox\").addClass(\"me\");\r\n");
      out.write("\t\t$(\"#msgBox\").addClass(\"none\");\r\n");
      out.write(" \t}\r\n");
      out.write("\tif(cnt==10){\r\n");
      out.write("\t\t$(\"#msgBox\").removeClass(\"none\");\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\tif(cnt==13){\r\n");
      out.write("\t\t$(\"#msgBox\").removeClass(\"you\");\r\n");
      out.write("\t\t$(\"#msgBox\").addClass(\"me\");\r\n");
      out.write("\t\t$(\"#people\")[0].play();\r\n");
      out.write("\t}\r\n");
      out.write("\tif(cnt==14)$(\"#msgBox\").removeClass(\"me\");\r\n");
      out.write("\tif(cnt==15)$(\"#msgBox\").addClass(\"me\");\r\n");
      out.write("\tif(cnt==16){\r\n");
      out.write("\t\t$(\"#msgBox\").removeClass(\"me\");\r\n");
      out.write("\t\t$(\"#msgBox\").addClass(\"you\");\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tif(cnt==27) $(\"#trueEnd\")[0].pause();\r\n");
      out.write("\t\r\n");
      out.write("\tif(cnt==28){\r\n");
      out.write("\t\t$(\"#msgBox\").removeClass(\"me\");\r\n");
      out.write("\t\t$(\"#msgBox\").addClass(\"you\");\r\n");
      ...
      out.write("\t\t$(\"#msgBox\").addClass(\"me\");\r\n");
      out.write("\t\t$(\"#msgBox\").addClass(\"none\");\r\n");
      out.write("\t\t$(\"#footprint\")[0].play();\r\n");
      out.write("\t}\r\n");
      out.write("\tif(cnt==31)$(\"#msgBox\").removeClass(\"none\");\r\n");
      out.write("\tif(cnt==32){\r\n");
      out.write("\t\t$(\"#msgBox\").removeClass(\"me\");\r\n");
      out.write("\t\t$(\"#msgBox\").addClass(\"you\");\r\n");
      out.write("\t}\r\n");
      out.write("\tif(cnt==33) $(\"#msgBox\").addClass(\"me\");\r\n");
      out.write("\tif(cnt==33){\r\n");
      out.write("\t\t$(\"#msgBox\").removeClass(\"me\");\r\n");
      out.write("\t\t$(\"#msgBox\").addClass(\"none\");\r\n");
      out.write("\t\t$(\"#reload\")[0].play();\r\n");
      out.write("\t}\r\n");
      out.write("\tif(cnt==34){\r\n");
      out.write("\t\t$(\"#msgBox\").removeClass(\"none\");\r\n");
      out.write("\t\t$(\"#msgBox\").removeClass(\"you\");\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/images/game/trueEnding/\"+data.fileName).fadeIn(1500);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
