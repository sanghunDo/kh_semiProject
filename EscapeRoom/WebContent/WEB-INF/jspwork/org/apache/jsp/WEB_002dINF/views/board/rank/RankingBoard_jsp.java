 ...
 * Generated at: 2019-01-17 07:29:55 UTC
...
if(list.get(2).getUserprofilerenamedfile() == null || list.get(2).getUserprofilerenamedfile().isEmpty()) { 
 ...
 if(loggedInMember != null && (rc.getCommentWriter().equals(loggedInMember.getUserId()) || "admin".equals(loggedInMember.getUserId()))) {
      ...
      out.write("\t<script>\r\n");
      out.write("\t\t/* 중복 방지! */\r\n");
      out.write("\t\tvar doubleSubmitFlag = false;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction doubleSubmitCheck() {\r\n");
      out.write("\t\t\tif(doubleSubmitFlag) {\r\n");
      out.write("\t\t\t\treturn doubleSubmitFlag;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\telse {\r\n");
      out.write("\t\t\t\tdoubleSubmitFlag = true;\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\r\n");
 ...
 if(loggedInMember != null) {
      out.write("\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\tvar commentWriter = $(this).parent().find(\".rComment-Writer\").html().trim();\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif(doubleSubmitCheck()) {\r\n");
      out.write("\t\t\t\t\talert(\"추천은 한번만 하실 수 있습니다.\");\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t");
 ...
 if(loggedInMember != null) {
      out.write("\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\tvar cw = $(this).parent().find(\".rComment-Writer\").html().trim();\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif(doubleSubmitCheck()) {\r\n");
      out.write("\t\t\t\t\talert(\"비추천은 한번만 하실 수 있습니다.\");\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t");
}
...
if(loggedInMember != null) {
      out.write("\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\tvar cw = $(\".rankLevel1\").parent().find(\".rComment-Writer\").html().trim();\r\n");
      ...
      out.print(loggedInMember.getUserId());
      out.write("\") {\r\n");
      out.write("\t\t\t\t\talert(\"본인이 작성한 댓글은 신고할 수 없습니다.\");\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\telse {\r\n");
