 ...
 * Generated at: 2019-01-13 13:46:11 UTC
...
if(list.get(2).getUserprofilerenamedfile() == null || list.get(2).getUserprofilerenamedfile().isEmpty()) { 
 ...
 if(list == null || list.isEmpty()) { 
      ...
      out.write("         </form>\r\n");
      out.write("         <hr style=\"margin-top:-29.5px;\"/>\r\n");
      out.write("         \r\n");
      out.write("      </div>\r\n");
      out.write("      \r\n");
      out.write("      \r\n");
 ...
 if(loggedInMember != null && (rc.getCommentWriter().equals(loggedInMember.getUserId()) || "admin123".equals(loggedInMember.getUserId()))) {
      ...
      out.write("\t\t \t\t\t\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/board/rank/RankBoardCommentDelete\" name=\"deleteRankCommentFrm\">\r\n");
      ...
      out.write("\t\t \t\t\t</td>\r\n");
      out.write("\t\t \t\t\t\r\n");
      out.write("\t\t \t\t\t<!-- 관리자이거나 본인이 쓴 댓글(대댓글)에 대해서만 삭제버튼이 보여야하며,\r\n");
      out.write("\t\t \t\t\t\t 삭제 요청 처리 이후에는 현재 페이지가 다시 보여져야 한다. -->\r\n");
      out.write("\t\t \t\t</tr>\r\n");
      out.write("\t\t \t\t\r\n");
      out.write("\t\t \t");
}} 
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"[name=deleteRankCommentFrm]\").submit();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("   <!-- 댓글 끝 -->");
