 ...
 * Generated at: 2019-01-17 09:32:06 UTC
...
for(int i=0; i<commentList.size(); i++){
      ...
      out.write("                          ");
      out.print((bc.getCommentContent().equals("해당 댓글은 관리자에 의해 삭제되었습니다.")&&bc.getCommentReport().equals("Y"))?"":bc.getCommentWriter());
      out.write("\r\n");
      out.write("                        <i>");
      out.print((bc.getCommentContent().equals("해당 댓글은 관리자에 의해 삭제되었습니다.")&&bc.getCommentReport().equals("Y"))?"":bc.getCommentDate() );
      out.write("</i>\r\n");
      out.write("                    </dt>\r\n");
      out.write("                    \r\n");
...
if(loggedInMember!= null && ("admin".equals(loggedInMember.getUserId()) ||  fb.getPostWriter().equals(loggedInMember.getUserId()))) {
      ...
      out.write("                  html+=\"<div class='level2Report' onclick=report(\"+user.commentNo+\",'\"+user.commentWriter+\"','\"+user.commentContent+\"',\"+");
      out.print(fb.getPostNo());
      out.write("+\");>신고하기</div>\";                               \r\n");
      ...
      out.write("    }\r\n");
      out.write("    /*댓글신고하기*/\r\n");
      out.write("    function report(item, item2, item3 , postNo){\r\n");
      out.write("    \tvar commentNo = item;\r\n");
      out.write("    \tvar commentWrtier = item2;\r\n");
      out.write("    \tvar commentContent = item3;\r\n");
      out.write("    \tvar postNo = postNo;\r\n");
      out.write("    \t\r\n");
      out.write("    \tconsole.log(postNo);\r\n");
      out.write("    \t\r\n");
      ...
      out.write("        var url = \"");
      out.print(request.getContextPath() );
      out.write("/board/free/freeBoardCommentReport?commentNo=\"+commentNo+\"&commentWriter=\"+commentWrtier+\"&commentContent=\"+commentContent+\"&postNo=\"+postNo;\r\n");
      out.write("    \t   \r\n");
      out.write("    \t   // 팝업창 이름\r\n");
      out.write("        var title = \"Report\";\r\n");
      out.write("    \tvar status = \"left=500px, top=200px, width=600px, height=600px\";\r\n");
