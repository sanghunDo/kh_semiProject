 ...
 * Generated at: 2019-01-10 10:04:35 UTC
...
public final class freeBoardView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1547113436414L));
  }
...
if("admin".equals(loggedInMember.getUserId())){ 
      ...
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/home/homeGetData\">HOME</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
...
for(BoardComment bc:bestCommentList)
      ...
      out.write("            </dl>\r\n");
      out.write("\r\n");
      out.write("            <dl class=\"bestCommentOpinion\" style=\"position: relative;top: -120px;left: -33px; color:black;\">\r\n");
...
for(int i=0; i<commentList.size(); i++){
      ...
      out.write("                  html+=\"<div class='level2Like'>추천 23</div>\";\r\n");
      out.write("                  html+=\"<div class='level2Dislike'>비추천 0</div>\";\r\n");
      out.write("               \r\n");
      ...
      out.write("\t           url:\"");
      out.print(request.getContextPath());
      out.write("/board/free/freeBoardCommentUpdate.do\",\r\n");
      out.write("\t           data:{commentUpdate:commentUpdate, commentNo:commentNo},\r\n");
      out.write("\t           success:function(data){\r\n");
