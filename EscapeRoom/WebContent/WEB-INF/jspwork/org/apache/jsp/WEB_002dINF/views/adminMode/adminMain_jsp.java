 ...
 * Generated at: 2019-01-15 19:19:26 UTC
...
if("admin".equals(loggedInMember.getUserId())){ 
	...
	List<Report_Comment> rcList = (List<Report_Comment>) request.getAttribute("rcList");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function deleteReportComment(postNo, commentNo, category){\r\n");
      out.write("\tvar temp = confirm(\"해당 댓글에 대한 신고를 취소하시겠습니까?\");\r\n");
      out.write("\tif(!temp) return;\r\n");
      out.write("\telse location.href = \"");
      out.print(request.getContextPath());
      out.write("/adminMode/deleteReportComment?postNo=\" + postNo + \"&commentNo=\" + commentNo + \"&category=\" + category;\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
...
if("F".equals(rb.getCategory())) {
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<button class=\"notOK\">삭제</button>\r\n");
      out.write("\t\t\t\t&nbsp;\r\n");
