 ...
 * Generated at: 2019-01-15 17:46:03 UTC
...
if(loggedInMember!= null && ("admin".equals(loggedInMember.getUserId()) ||  bc.getCommentWriter().equals(loggedInMember.getUserId()))) {
      ...
      out.write("                <div  class=\"bestCommentUpdate\" no=");
      out.print(i );
      out.write(">수정하기</div>\r\n");
      out.write("                <div  no=");
      out.print(i );
      ...
      out.print(request.getContextPath());
      out.write("/board/solve/solveBoardCommentDelete\" name=\"bestCommentDeleteFrm\">\r\n");
      ...
      out.write("                    </form>\r\n");
      out.write("\r\n");
      out.write("            <dl class=\"bestCommentOpinion\"   no=");
      out.print(i );
      out.write(">\r\n");
...
if(loggedInMember!= null && ("admin".equals(loggedInMember.getUserId()) ||  sb.getPostWriter().equals(loggedInMember.getUserId()))) {
      ...
      out.write("        $(\".bestCommentOpinion[no=\"+no+\"]\").css(\"display\",\"none\");\r\n");
      ...
      out.write("        var url = \"");
      out.print(request.getContextPath() );
      out.write("/board/solve/solveBoardCommentReport?commentNo=\"+commentNo+\"&commentWriter=\"+commentWrtier+\"&commentContent=\"+commentContent;\r\n");
      out.write("    \t   \r\n");
      out.write("    \t   // 팝업창 이름\r\n");
      ...
      out.write("\t\t  var url = \"");
      out.print(request.getContextPath() );
      out.write("/board/solve/solveBoardPostReport?postNo=\"+postNo+\"&postTitle=\"+postTitle+\"&postWriter=\"+postWriter;\r\n");
      out.write("\t      var title = \"Report\";\r\n");
      out.write("\t      var status = \"left=500px, top=200px, width=600px, height=600px\";\r\n");
      out.write("\t    \t   \r\n");
      out.write("\t      open(url, title, status);\r\n");
      ...
      out.write("              url:\"");
      out.print(request.getContextPath());
      out.write("/board/solve/solveBoardDisike.do\",\r\n");
      out.write("              data:{postNo:postNo, userId:item},\r\n");
      out.write("              success:function(data){\r\n");
