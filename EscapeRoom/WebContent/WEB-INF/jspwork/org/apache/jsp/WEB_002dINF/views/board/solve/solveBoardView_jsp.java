 ...
 * Generated at: 2019-01-14 07:08:38 UTC
...
if(loggedInMember!= null && ("admin".equals(loggedInMember.getUserId()) ||  sb.getPostWriter().equals(loggedInMember.getUserId()))) {
      ...
      out.write("\r\n");
      out.write("\t\t\t\t  /* html+=\"<div class='level2Like' no='\"+i+\"' clickNum=0>추천 \"+user.commentLike+\"</div>\"; */\r\n");
      ...
      out.write("\t\t  console.log(\"postTitle=\"+postTitle);\r\n");
      out.write("\t\t  console.log(\"postWriter=\"+postWriter);\r\n");
      out.write("\r\n");
      out.write("\t\t  var url = \"");
      out.print(request.getContextPath() );
