 ...
 * Generated at: 2019-01-11 20:54:44 UTC
...
public final class gameMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/game/gameController.jsp", Long.valueOf(1547240082771L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	Member loggedInMember = (Member)session.getAttribute("loggedInMember");
      ...
      out.write("\t\t\t\tif(obj.position==position){\r\n");
      out.write("\t\t\t\t\tvar html = \"<img src='");
      out.print(request.getContextPath());
      out.write("/images/game/gameMain/\"+position+\"/\"+obj.objName+\".png' class='obj'/>\";\r\n");
      ...
      out.write("\t$(\"#wrap>img\").each(function(){\r\n");
      out.write("\t\t$(this).on('click', function(){\r\n");
      out.write("\t\t\t$(\"#wrap\").append(\"<img src='");
      out.print(request.getContextPath());
      out.write("/images/game/gameMain/clicked/\"+$(this).prop(\"id\")+\"_clicked.png' id='clicked' onclick='obj_reClick();'/>\");\r\n");
      out.write("\t\t\t$(\"#wrap *, #back-ground\").not(\"#clicked, #coment, #coment *\").addClass(\"paused\");\r\n");
      out.write("\t\t\tshow_coment($(this).prop(\"id\"));\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("};\r\n");
      out.write("function obj_reClick(){\r\n");
      out.write("\t$(\"body *\").removeClass(\"paused\");\r\n");
      out.write("\t$(\"#wrap\").find(\"img\").remove(\"#clicked\");\r\n");
      out.write("\t$(\"#coment\").hide();\r\n");
      out.write("};\r\n");
      out.write("function show_coment(objName){\r\n");
      ...
      out.write("\t\t\tvar objArr = root.find(\"obj\");\r\n");
      out.write("\t\t\tobjArr.each(function(){\r\n");
      out.write("\t\t\t\tif($(this).find(\"objName\").text()==objName){\r\n");
      out.write("\t\t\t\t\tcoment = $(this).find(\"coment\").text();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$(\"#coment\").show();\r\n");
      out.write("\t\t\ttarget.text(coment);\r\n");
      out.write("\t\t\ttarget.parent().css(\"width\",target.outerWidth());\r\n");
      out.write("\t\t\tvar length = coment.length;\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/images/game/gameMain/front/background.png\")\r\n");
      ...
      out.write("\tvar cnt = e.data.flag++;\r\n");
      out.write("\t$(\"img\").not(\"#pause img, #hint img\").toggleClass(\"paused\");\r\n");
