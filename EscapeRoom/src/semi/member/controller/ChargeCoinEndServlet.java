...
public class ChargeCoinEndServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String userId = request.getParameter("userId").equals("null")?"":request.getParameter("userId");
		System.out.println("유저아이디(userId)@ChargeCoinEndServlet = " + userId);


		int coin = (int)(Integer.parseInt(request.getParameter("coin")))==0?0:(int)(Integer.parseInt(request.getParameter("coin")));
