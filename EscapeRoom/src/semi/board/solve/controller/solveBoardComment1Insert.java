...
/**
 * Servlet implementation class solveBoardComment1Insert
 */
@WebServlet("/board/solve/solveBoardCommentInsert")
public class solveBoardComment1Insert extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public solveBoardComment1Insert() {
        super();
