...
public class SolveBoard implements Serializable {
	private int postNo;
	...
	public SolveBoard(int postNo, String postTitle, String postWriter, String postContent, String postOriginalFile,
